...
<div class="portlet box blue">
	...
	{% endif %}
		...
		<label name="gallery_name_lbl" id ="gallery_name_lbl" class="control-label col-md-3 formlabel">
		{{'Gallery'|t}}
		</label>
		<div class="col-md-4">
		{{ text_field("gallery_name", "size": 32 ,"readonly":"","value":gallery_name,"class":"form-control") }}
		</div>
		</div>
